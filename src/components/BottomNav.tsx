...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border">
      <div className="flex items-center justify-around max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto h-16 px-2">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-0.5 flex-1 h-full transition-colors md:flex-row md:gap-2",
